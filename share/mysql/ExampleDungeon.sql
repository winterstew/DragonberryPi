-- MySQL dump 10.15  Distrib 10.0.23-MariaDB, for debian-linux-gnueabihf (armv7l)
--
-- Host: localhost    Database: DragonberryPi
-- ------------------------------------------------------
...
INSERT INTO `Adventure` (`idAdventure`, `name`, `description`, `updated`) VALUES (1,'Dangerous Dungeon','Example Dungeon','2016-01-31 06:22:55');
/*!40000 ALTER TABLE `Adventure` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `AdventureIllustation`
--

DROP TABLE IF EXISTS `AdventureIllustation`;
/*!50001 DROP VIEW IF EXISTS `AdventureIllustation`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `AdventureIllustation` (
...
INSERT INTO `AdventureMap` (`idAdventureMap`, `idAdventure`, `idMap`, `updated`) VALUES (1,1,1,'2016-01-31 06:24:46'),(2,1,2,'2016-01-31 06:24:46'),(3,1,3,'2016-02-05 08:04:01'),(4,1,4,'2016-02-05 08:04:01'),(5,1,5,'2016-03-12 03:51:50');
...
CREATE TABLE `Display` (
  ...
  KEY `updated` (`updated`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='The Display will be a portion of the browser as a <DIV> elem';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Display` (`idDisplay`, `name`, `position`, `width`, `height`, `top`, `bottom`, `left`, `right`, `transform`, `backgroundColor`, `depth`, `updated`) VALUES (1,'Main Map','fixed','90%','100%','0',NULL,'10%',NULL,NULL,NULL,10,'2016-02-06 22:36:19'),(2,'TL Inset','fixed','200px','200px','0',NULL,'0',NULL,NULL,NULL,1,'2016-02-05 08:28:21'),(3,'BL Inset','fixed','200px','200px',NULL,'0','0',NULL,NULL,NULL,1,'2016-02-05 08:28:21'),(4,'CL Inset','fixed','300px','300px','50%',NULL,'0',NULL,'translateY(-50%)',NULL,2,'2016-02-05 08:28:21'),(5,'pawnGridList','fixed','140px','5%','0',NULL,NULL,'60px',NULL,NULL,6,'2016-03-01 13:00:08'),(6,'illustrationList','fixed','140px','80%','5%',NULL,NULL,'60px',NULL,NULL,5,'2016-03-01 13:00:08'),(7,'overviewMapList','fixed','140px','15%','85%','0',NULL,'60px',NULL,NULL,4,'2016-03-01 13:00:08'),(8,'modifierSelectors','fixed','60px','100%','0',NULL,NULL,'0',NULL,NULL,3,'2016-03-01 12:40:02'),(9,'pawnStatsDown','fixed','70%','30px',NULL,'15px','20%',NULL,NULL,'rgba(211, 211, 211, 0.5)',8,'2016-02-08 12:01:26'),(10,'pawnStatsUp','fixed','70%','30px','15px',NULL,'20%',NULL,NULL,'rgba(211, 211, 211, 0.5)',8,'2016-02-08 12:01:26');
...
INSERT INTO `Image` (`idImage`, `idLocation`, `filename`, `type`, `width`, `height`, `ruleLink`, `idSource`, `updated`) VALUES (1,2,'blank.png','PNG',570,700,NULL,1,'2016-01-31 03:46:40'),(2,4,'overview.jpg','JPEG',600,350,'http://donjon.bin.sh/code/world/',2,'2016-01-31 06:20:00'),(3,5,'Corridor 1.png','PNG',223,306,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(4,5,'Corridor 2a.png','PNG',530,114,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(5,5,'Corridor 2b.png','PNG',132,296,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(6,5,'Corridor 2c.png','PNG',501,101,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(7,5,'Corridor 2d.png','PNG',490,99,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(8,5,'Corridor 2e.png','PNG',94,189,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(9,5,'Corridor 3a.png','PNG',118,300,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:19'),(10,5,'Corridor 3b.png','PNG',200,150,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(11,5,'Corridor 4.png','PNG',106,190,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(12,5,'Corridor 5a.png','PNG',107,513,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(13,5,'Corridor 5b.png','PNG',413,114,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(14,5,'Corridor 5c.png','PNG',115,205,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(15,5,'Corridor 5d.png','PNG',107,202,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(16,5,'Corridor 6a.png','PNG',219,107,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(17,5,'Corridor 6b.png','PNG',95,407,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(18,5,'Dangerous Dungeon.png','PNG',1151,1451,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(19,5,'Entry.png','PNG',625,125,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(20,5,'Locked Door 1.png','PNG',101,103,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(21,5,'Room 1.png','PNG',531,228,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(22,5,'Room 2.png','PNG',309,298,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(23,5,'Room 3.png','PNG',598,302,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(24,5,'Room 4.png','PNG',210,201,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(25,5,'Room 5.png','PNG',410,498,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(26,5,'Room 6.png','PNG',211,402,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(27,5,'Secret Door 1.png','PNG',114,107,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(28,5,'Stair Down.png','PNG',491,108,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:20'),(29,5,'Stair Up.png','PNG',118,197,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-02-04 18:17:30'),(30,5,'Trapped Door 1.png','PNG',104,106,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:21'),(31,5,'Trapped Door 2.png','PNG',93,98,'http://donjon.bin.sh/fantasy/dungeon/',2,'2016-01-31 06:19:21'),(32,3,'bullrog_ogre_street_mage_by_xaarex.png','PNG',1006,659,'http://xaarex.deviantart.com/art/Bullrog-Ogre-Street-Mage-397799952',6,'2016-03-12 03:36:57'),(33,3,'orc_render_wip_2_2_by_whitekidz-d8ospmi.jpg','JPEG',627,837,'http://whitekidz.deviantart.com/art/Orc-Render-Wip-2-2-525379770',5,'2016-03-12 03:36:57'),(34,3,'orc_warrior_by_puppeli.png','PNG',492,694,'http://puppeli.deviantart.com/art/orc-warrior-58162296',4,'2016-03-12 03:36:57'),(35,3,'ogre.png','PNG',244,242,NULL,1,'2016-03-12 04:11:13'),(36,2,'B.png','PNG',570,700,NULL,1,'2016-03-12 04:23:58'),(37,2,'F.png','PNG',570,700,NULL,1,'2016-03-12 04:23:59'),(38,2,'G.png','PNG',570,700,NULL,1,'2016-03-12 04:24:00'),(39,3,'goblin.png','PNG',580,596,NULL,1,'2016-03-12 06:47:53');
...
INSERT INTO `Location` (`idLocation`, `name`, `depth`, `idParent`, `updated`) VALUES (1,'/home/pi/DragonberryPi/app/public',0,NULL,'2016-01-31 03:44:55'),(2,'/images',1,1,'2016-01-31 03:44:55'),(3,'/Monsters',2,2,'2016-01-31 06:19:19'),(4,'/Illustrations',2,2,'2016-01-31 06:19:19'),(5,'/Map Tiles',2,2,'2016-01-31 06:19:19');
...
CREATE TABLE `Map` (
  ...
  KEY `updated` (`updated`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='define a map made up of tiles.  Every Map will be layed out ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Map` (`idMap`, `name`, `pixelsPerFoot`, `feetPerInch`, `widthInches`, `heightInches`, `rotate`, `scale`, `translateX`, `translateY`, `visible`, `dmVisible`, `depth`, `backgroundColor`, `idDisplay`, `idMapType`, `updated`) VALUES (1,'Deadly Dungeon',10,5,32,20,-90,1,0,0,1,1,5,NULL,1,1,'2016-03-12 04:13:12'),(2,'Port View',NULL,NULL,NULL,NULL,-90,1,0,0,1,1,2,NULL,4,2,'2016-03-12 05:33:14'),(3,'goblin',NULL,NULL,NULL,NULL,0,1,0,0,0,0,1,NULL,2,3,'2016-03-12 04:15:10'),(4,'Ogre',NULL,NULL,NULL,NULL,-90,1,0,0,0,1,1,NULL,3,3,'2016-03-12 04:37:13'),(5,'Orc',NULL,NULL,NULL,NULL,-90,1,0,0,0,1,1,NULL,2,3,'2016-03-12 04:37:12');
...
CREATE TABLE `MapType` (
  ...
  KEY `updated` (`updated`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Type of "Map", is it a PawnGrid, an OverviewMap, or a Headsh';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `MapType` (`idMapType`, `name`, `description`, `updated`) VALUES (1,'pawnGrid','Grid for pawn movement encounters','2016-01-31 03:44:55'),(2,'overviewMap','Overview map of region','2016-01-31 03:44:55'),(3,'illustration','NPC or monster head shot or picture','2016-01-31 03:44:55');
...
INSERT INTO `Modifiers` (`idModifiers`, `idPawn`, `idModifier`, `updated`) VALUES (13,5,8,'2016-02-04 14:21:27'),(16,1,16,'2016-02-08 12:02:49');
...
INSERT INTO `Pawn` (`idPawn`, `name`, `selectKey`, `rotate`, `sizeFeet`, `translateX`, `translateY`, `color`, `height`, `attackRange`, `attackType`, `visible`, `dmVisible`, `depth`, `backgroundColor`, `ruleLink`, `idImage`, `imageX`, `imageY`, `imageScale`, `idMap`, `idRole`, `updated`) VALUES (1,'Baldfist','1',-90,5,946.0234674329,340.44300766286,'#FF0101',0,-5,'Cone',1,1,1,'#FFAAAA',NULL,36,0,0,1,1,1,'2016-03-12 04:30:04'),(2,'Filerna','2',-90,5,996.0234674329,343.436302682,'#01FF01',0,0,'Line',1,1,1,'#AAFFAA',NULL,37,0,0,1,1,1,'2016-03-12 04:30:04'),(3,'Grub','3',-135,5,1046.0234674329,293.436302682,'#0101FF',0,0,'None',1,1,1,'#AAAAFF',NULL,38,0,0,1,1,1,'2016-03-12 04:30:31'),(4,'goblin 1','q',45,5,746.46312260536,391.97318007663,'#017050',0,15,'Cone',0,1,1,'#FFFFFF','http://paizo.com/pathfinderRPG/prd/bestiary/goblin.html#goblin',39,0,0,1,1,3,'2016-03-12 06:44:37'),(5,'goblin 2','w',0,5,1045.9865900383,191.49664750958,'#017050',0,0,'None',1,1,1,'#FFFFFF','http://paizo.com/pathfinderRPG/prd/bestiary/goblin.html#goblin',39,0,0,1,1,3,'2016-03-12 06:44:37'),(6,'goblin 3','e',45,5,845.51005747125,391.02011494253,'#017050',0,0,'None',0,1,1,'#FFFFFF','http://paizo.com/pathfinderRPG/prd/bestiary/goblin.html#goblin',39,0,0,1,1,3,'2016-03-12 06:44:37'),(7,'orc 1','r',90,5,398.02681992337,639.93295019158,'#015001',0,0,'None',0,1,1,'#FFFFFF','http://paizo.com/pathfinderRPG/prd/bestiary/orc.html#orc',33,-110,0,1.5,1,6,'2016-03-18 10:35:22'),(8,'orc 2','t',-90,5,697.55028735632,640.9530651341,'#015001',0,0,'Line',0,1,1,'#FFFFFF','http://paizo.com/pathfinderRPG/prd/bestiary/orc.html#orc',33,-110,0,1.5,1,6,'2016-03-18 10:35:20'),(9,'ogre','y',45,10,444.96647509579,980.61063218391,'#501010',0,0,'None',0,1,1,'#FFFFFF','http://paizo.com/pathfinderRPG/prd/bestiary/ogre.html#ogre',35,0,0,1,1,7,'2016-03-18 10:35:23');
...
CREATE TABLE `Pointer` (
  `idPointer` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `selectKey` char(1) DEFAULT NULL,
  `shapeSvg` blob NOT NULL,
  `rotate` double NOT NULL DEFAULT '0',
...
INSERT INTO `Pointer` (`idPointer`, `name`, `selectKey`, `shapeSvg`, `rotate`, `scale`, `translateX`, `translateY`, `visible`, `updated`) VALUES (1,'target-pointer','b','     width=\"100%\" \n     height=\"100%\" \n     version=\"1.1\"\n     xmlns=\"http://www.w3.org/2000/svg\"\n     xmlns:xlink=\"http://www.w3.org/1999/xlink\">\n    <g\n       id=\"target\"\n       transform=\"translate(0,-1052.36216)\">\n       <animate id=\"fullFade\" begin=\"accessKey(b)\" dur=\"24.0s\" />\n       <g \n         id=\"outer-ring\">\n         <path\n            transform=\"translate(0,552.36216)\"\n            d=\"M 0,250 A 250,250 0 0 0 -250,500 250,250 0 0 0 0,750 250,250 0 0 0 250,500 250,250 0 0 0 0,250 Z m 0,50 A 200,200 0 0 1 200,500 200,200 0 0 1 0,700 200,200 0 0 1 -200,500 200,200 0 0 1 0,300 Z\"\n            style=\"opacity:1;fill:#ff41ff;fill-opacity:1;stroke:none;stroke-width:0.5;stroke-linecap:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"0\" begin=\"fullFade.begin+0.0s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"1\" begin=\"fullFade.begin+0.5s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"1\" begin=\"fullFade.begin+1.0s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"0\" begin=\"fullFade.begin+2.5s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"0\" begin=\"fullFade.begin+3.0s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"1\" begin=\"fullFade.begin+4.5s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"1\" begin=\"fullFade.begin+5.0s\" dur=\"1.0s\" />\n       </g>\n       <g \n         id=\"middle-ring\">\n         <path\n            d=\"M 0,878.1236 A 174.23857,174.23857 0 0 0 -174.23857,1052.3622 174.23857,174.23857 0 0 0 0,1226.6008 174.23857,174.23857 0 0 0 174.23857,1052.3622 174.23857,174.23857 0 0 0 0,878.1236 Z m 0,34.84771 A 139.39085,139.39085 0 0 1 139.39085,1052.3622 139.39085,139.39085 0 0 1 0,1191.753 139.39085,139.39085 0 0 1 -139.39085,1052.3622 139.39085,139.39085 0 0 1 0,912.97131 Z\"\n            style=\"opacity:1;fill:#ff73ff;fill-opacity:1;stroke:none;stroke-width:0.5;stroke-linecap:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"0\" begin=\"fullFade.begin+0.0s\" dur=\"1.0s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"1\" begin=\"fullFade.begin+1.0s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"1\" begin=\"fullFade.begin+1.5s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"0\" begin=\"fullFade.begin+3.0s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"0\" begin=\"fullFade.begin+3.5s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"1\" begin=\"fullFade.begin+5.0s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"1\" begin=\"fullFade.begin+5.5s\" dur=\"0.5s\" />\n       </g>\n       <g \n         id=\"inner-ring\">\n         <path\n            d=\"M 0,937.7226 A 114.63958,114.63958 0 0 0 -114.63958,1052.3622 114.63958,114.63958 0 0 0 0,1167.0018 114.63958,114.63958 0 0 0 114.63958,1052.3622 114.63958,114.63958 0 0 0 0,937.7226 Z m 0,22.92791 A 91.71166,91.71166 0 0 1 91.71166,1052.3622 91.71166,91.71166 0 0 1 0,1144.0738 91.71166,91.71166 0 0 1 -91.71166,1052.3622 91.71166,91.71166 0 0 1 0,960.65051 Z\"\n            style=\"opacity:1;fill:#ffc3ff;fill-opacity:1;stroke:none;stroke-width:0.5;stroke-linecap:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"0\" begin=\"fullFade.begin+0.0s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"1\" begin=\"fullFade.begin+1.5s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"1\" begin=\"fullFade.begin+2.0s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"0\" begin=\"fullFade.begin+3.5s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"0\" begin=\"fullFade.begin+4.0s\" dur=\"1.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"0\" to=\"1\" begin=\"fullFade.begin+5.5s\" dur=\"0.5s\" />\n         <animate attributeType=\"CSS\" attributeName=\"opacity\" from=\"1\" to=\"1\" begin=\"fullFade.begin+6.0s\" dur=\"0.0s\" />\n       </g>\n    </g>\n',0,1,0,0,1,'2016-04-02 23:43:28');
...
CREATE TABLE `Role` (
  ...
  PRIMARY KEY (`idRole`),
  KEY `updated` (`updated`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='What role does this Pawn play: PC, PCLeader, NPC, NPCMonster';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Role` (`idRole`, `name`, `updated`) VALUES (1,'pc','2016-01-31 03:44:55'),(2,'npc','2016-01-31 03:44:55'),(3,'monster','2016-01-31 03:44:55'),(4,'label','2016-01-31 03:44:55'),(5,'trap','2016-01-31 03:44:55'),(6,'monster','2016-01-31 06:55:55'),(7,'monster','2016-01-31 06:55:55');
...
INSERT INTO `Source` (`idSource`, `name`, `description`, `copyright`, `updated`) VALUES (1,'Unknown',NULL,NULL,'2016-01-31 03:44:55'),(2,'http://donjon.bin.sh/fantasy/dungeon/','Random Dungeon Generator on donjon.bin.sh','code Copyright &copy; 2009-2016 drow','2016-02-01 12:39:30'),(3,'http://donjon.bin.sh/world/','Fractal World Generator on donjon.bin.sh','code Copyright &copy; 2009-2016 drow','2016-02-01 12:39:30'),(4,'puppeli @ Deviant Art','http://fav.me/dymmbc','https://creativecommons.org/licenses/by-sa/3.0/deed.en','2016-03-12 01:30:06'),(5,'whitekidz @ Deviant Art','http://fav.me/d8ospmi','https://creativecommons.org/licenses/by-sa/3.0/deed.en','2016-03-12 01:31:21'),(6,'xaarex @ Deviant Art','http://fav.me/d6ku8eo','https://creativecommons.org/licenses/by-sa/3.0/deed.en','2016-03-12 01:32:58');
...
CREATE TABLE `Tile` (
  ...
  KEY `idMap` (`idMap`),
  KEY `updated` (`updated`)
) ENGINE=MyISAM AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='specify geometric location and the visibility of Tile elemen';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Final view structure for view `AdventureIllustation`
--

/*!50001 DROP TABLE IF EXISTS `AdventureIllustation`*/;
/*!50001 DROP VIEW IF EXISTS `AdventureIllustation`*/;
...
-- Dump completed on 2016-04-03  1:41:40
